...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { cook_date: @batch.cook_date, input: @batch.input, product: @batch.product } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { cook_date: @batch.cook_date, input: @batch.input, product: @batch.product } }
