...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference('Turn.count') do
      post turns_url, params: { turn: { product: @turn.product, production_date: @turn.production_date, turn_number: @turn.turn_number } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { product: @turn.product, production_date: @turn.production_date, turn_number: @turn.turn_number } }
