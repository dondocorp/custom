...
class InputsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create input" do
    assert_difference('Input.count') do
      post inputs_url, params: { input: { delivery_date: @input.delivery_date, product: @input.product, quantity: @input.quantity } }
    end
  ...
  test "should update input" do
    patch input_url(@input), params: { input: { delivery_date: @input.delivery_date, product: @input.product, quantity: @input.quantity } }
